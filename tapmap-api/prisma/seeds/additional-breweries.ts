...
const BREWERIES: BreweryData[] = [
  {
    ...
    beers: [
      { name: '10% Světlá výčepní', styleName: 'Pilsner', abv: 4.2 },
      { name: '11% Světlý ležák', styleName: 'Pilsner', abv: 4.7 },
      { name: '11% Polotmavý ležák', styleName: 'Amber Lager', abv: 4.5 },
      { name: '12% Světlý ležák', styleName: 'Pilsner', abv: 5.0 },
      { name: '11% American Pale Ale', styleName: 'APA', abv: 4.5, ibu: 40 },
      { name: '13% Single Hop IPA Citra', styleName: 'IPA', abv: 5.8, ibu: 45 },
      { name: '12% Medový ležák', styleName: 'Pilsner', abv: 5.0 },
      { name: '8% Cyklošvec', styleName: 'Pilsner', abv: 3.5 },
      { name: '10% Tmavá výčepní', styleName: 'Dark Lager', abv: 4.2 },
      { name: '13% Tmavý speciál', styleName: 'Dark Lager', abv: 5.8 },
